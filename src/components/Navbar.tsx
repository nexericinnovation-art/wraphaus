  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-secondary/95 backdrop-blur-md border-b border-border/10">
      <div className="container mx-auto px-4 flex items-center justify-between h-16 lg:h-20">
        <a href="#home" className="font-display text-2xl lg:text-3xl font-bold text-primary-foreground tracking-tight">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="lg:hidden bg-secondary border-t border-border/10 py-4 px-4">
          {navLinks.map((link) => (
            <a
              key={link.label}
              href={link.href}
