...
const slides = [
  { src: heroSlide1, alt: "Premium matte metallic blue sports car wrap" },
  { src: heroSlide2, alt: "Satin emerald green luxury SUV wrap" },
  { src: heroSlide3, alt: "Gloss nardo grey performance sedan wrap" },
];
      ...
      <div className="relative container mx-auto px-4 pt-20 lg:pt-0">
        <div className="max-w-2xl">
          ...
          >
            Turn Heads.
            <br />
            <span className="text-gradient-gold">Own the Road.</span>
          </motion.h1>
          ...
          >
            Expert car wrapping, PPF installation, ceramic coating, and auto detailing — right here in Nairobi.
          </motion.p>
